...
This examples illustrates how to serve TensorFlow model on Lambda Function for Image Classification.
...
![Configure test event](../img/tensorflow_configure_test_event.png)
...
![Lambda execution result](../img/tensorflow_execution_result.png)
